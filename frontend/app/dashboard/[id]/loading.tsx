  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0f172a" }}>
      <style>{`
        ...
        .sage-svg { width: 180px; height: 200px; overflow: visible; }
      ...
      <div className="sage-loader-container">
        <svg className="sage-svg" viewBox="0 0 200 220" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <circle className="aura-ring aura-1" cx="100" cy="100" r="70" fill="url(#auraGlow)" />
          <circle className="aura-ring aura-2" cx="100" cy="100" r="85" fill="none" stroke="#60a5fa" strokeWidth="1.5" strokeDasharray="4 6" />
